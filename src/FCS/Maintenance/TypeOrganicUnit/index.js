...
class TypeOrganicUnit extends Component {
    constructor(props) {
        super(props);
        this.state = {

            loaderData: true,
            module: "TIPOS DE UNIDADES ORGANICAS",
            showModal: false,
            loader: false,
            action: "add",
            titleModel: "",
    ...
    componentDidMount() {
        this.listTypeOrganictUnit();

    }

    async listTypeOrganictUnit() {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.typeOrganicUnit + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.typeOrganicUnit + '/' + id;
    ...
    render() {
        ...
        return (
            <>
                <TitleModule
                    actualTitle={this.state.module}
                    actualModule={this.state.module}
...
export default TypeOrganicUnit;