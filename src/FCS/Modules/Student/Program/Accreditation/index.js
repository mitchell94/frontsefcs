                ...
                <Row>
                    ...
                    <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                        <Card className="table-card">
                            <Card.Header>
                                <h5>REQUISITOS PRESENTADOS PARA LA ADMISIÓN EPG</h5>
                                                            ...
                                                            <div key={i} className="d-inline-block"
                                                                ...
                                                                <label
                                                                    ...
                                                                    <input type="checkbox" className="custom-control-input"
                                                                           onClick={r.exist ? () => this.updateRequerimentDelivered(r.id_requeriment_delivered) : () => this.createRequerimentDelivered(r.id)}
                                                                           checked={r.state}
                                                                           value={r.state}
                                                                           readOnly
                                                                    />
                                                                    < span className="custom-control-label">{r.description}</span>
                            ...
                            <nav className="navbar ">
                                ...
                                <div className="nav-item nav-grid f-view">
                                    <OverlayTrigger
                                        ...
                                        <button style={{marginRight: "8px"}} onClick={() => this.openFormDocument()} type="button" className="btn-icon btn btn-primary"><Add/>
                                        </button>
                                                    ...
                                                    <tr key={i}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <OverlayTrigger
                                                                ...
                                                                <Edit type="button" style={{color: "#1d86e0"}} onClick={() => this.retriveDocumentStudent(r)}/>

                                                            </OverlayTrigger>
                                                            <OverlayTrigger
                                                                overlay={<Tooltip>ELIMINAR</Tooltip>}>
                                                                <Delete type="button" style={{color: "#ff5252"}} onClick={() => this.deleteSweetDocumentStudent(r.Document.id)}/>
