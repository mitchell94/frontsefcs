    ...
    handleChange = field => event => {
        switch (field) {
            case 'process':
                ...
                break;
            case 'correlative':
                this.setState({correlative: event.target.value.replace(/^(0+)/g, '')});
                break;
            case 'observation':
                ...
                return (
                    <>
                        <OverlayTrigger
                            ...
                            <button onClick={() => this.callData()} type="button"
                            ...
                            return <>
                                ...
                                <OverlayTrigger
                                    ...
                                    <GetApp style={{color: "#101b33"}}
                                            onClick={() => this.reportActa(value.id)}
                                    />
            ...
            records.map((r, index) => {
                    ...
                    return (
                        data.push([
                            ...
                            r.Teacher.Person.name + ' / ' + r.Teacher.Person.document_number,
