                ...
                return (
                    <>
                        <OverlayTrigger
                            ...
                            <button onClick={() => this.props.openFormEntry()} type="button" className="btn-icon btn btn-primary"><i className="feather icon-plus"></i></button>
                            ...
                            return value ?
                                ...
                                <>
                                    ...
                                    <OverlayTrigger
                                        ...
                                        <Edit style={{color: "#1d86e0"}} onClick={() => this.props.retriveEntry(value)}/>

                                    </OverlayTrigger>
                                    <OverlayTrigger
                                        overlay={<Tooltip>ANULAR</Tooltip>}>
                                        <Delete style={{color: "#ff5252"}} onClick={() => this.props.deleteSweetEntry(value.id)}/>
