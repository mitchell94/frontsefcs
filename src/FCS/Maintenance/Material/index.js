...
class Material extends Component {
    ...
    async listMaterial() {
        ...
        const url = app.general + '/' + app.material;
        try {
    ...
    async update() {
        ...
        if (denomination !== '' && category !== '') {
            ...
            const url = app.general + '/' + app.material + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
            data.set('category', category);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.material + '/' + id;
    ...
    render() {
        ...
        const {showModal, loader, action, titleModal, category} = this.state;
        const {denomination} = this.state;
        const {records} = this.state;
        return (
            <>
                <TitleModule
                    actualTitle={"MATERIALES"}
                    actualModule={"MATERIALES Y SERVICIOS"}
