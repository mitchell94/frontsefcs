...
class TeacherEgressDataTable extends Component {
    ...
    render() {
                ...
                return (
                    <>
                        <OverlayTrigger
                            ...
                            <button onClick={() => this.props.openFormModalTeacherEgress()} type="button"
                                ...
                                <>
                                    <OverlayTrigger
                                        ...
                                        <Edit style={{color: "#1d86e0"}}
                                              onClick={() => this.props.retriveTeacherEgress(value)}
                                        />
                                    ...
                                    <OverlayTrigger
                                        ...
                                        <Delete style={{color: "#ff5252"}}
                                                onClick={() => this.props.sweetDeleteTeacherEgress(value.id)}
                                        />
                                    </OverlayTrigger>
                                </>
        ...
        if (records.length > 0) {
            records.map((r, index) => {
                    ...
                    return (
                        data.push([
                            index + 1,
                            r.Teacher !== null ? r.Teacher.name : 'No registrado',
                            r.type_teacher,
                            r.Course !== null ? r.Course.denomination : 'No def.',
                            r.amount,
                            r.state_egress,
                            r
                        ])
        ...
        return (
            ...
            <MuiThemeProvider theme={this.getMuiTheme()}>
                <MUIDataTable
                    title={"LISTADO DE EGRESOS DE DOCENTES"}
                    data={data}
                    columns={columns}
                    options={options}
                />
...
export default TeacherEgressDataTable;