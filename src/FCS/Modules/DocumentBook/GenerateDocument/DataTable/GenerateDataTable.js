        ...
        return (
          <>
            <OverlayTrigger overlay={<Tooltip>Recargar</Tooltip>}>
              <button
                onClick={() => this.listDocumentBook(this.state.process)}
                type="button"
            ...
            if (value === undefined) {
              ...
              return (
                <>
                  ...
                  <OverlayTrigger overlay={<Tooltip>DESCARGAR RECORD</Tooltip>}>
                    <GetApp
                      style={{ color: "#fbb901" }}
                      onClick={() =>
                        this.downloadPdf("record", value.id_student)
                      }
                    />
                  </OverlayTrigger>
                  {
                  ...
                  }
                  {
                    ...
                    (value.Concept.id === 1 || value.Concept.id === 2) && (
                      <OverlayTrigger overlay={<Tooltip>DESCARGAR</Tooltip>}>
                        <GetApp
                          style={{ color: "#ed5b4f" }}
                          onClick={() =>
                  ...
                  }
                  {
                    ...
                    (value.Concept.id === 111 || value.Concept.id === 119) && (
                      <OverlayTrigger overlay={<Tooltip>DESCARGAR</Tooltip>}>
                        <GetApp
                          style={{ color: "#20d1d1" }}
                          onClick={() =>
        ...
        <Modal show={this.state.modal} backdrop="static">
          <Modal.Header className="bg-primary">
            ...
            <div className="d-inline-block pull-right">
              <OverlayTrigger
                overlay={
                  <Tooltip style={{ zIndex: 100000000 }}>Cerrar</Tooltip>
                }
              >
                <Close
                  style={{ color: "white" }}
          ...
          <Modal.Body>
            <Row>
              <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                <Form.Group className="form-group fill">
                  <Form.Label className="floating-label">
                    Archivo<small className="text-danger"> *</small>
                  </Form.Label>
                  <InputGroup>
                    <Form.Control
                      style={{ marginTop: "3px" }}
              ...
              <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                ...
                {this.state.fileName && this.state.stateUpload && (
                  <Button
                    className="pull-right"
                    disabled={loaderDocumentBook}
                    variant="warning"
                    onClick={() =>
                      window.open(
                        app.server + "student-document/" + this.state.fileName,
                        "_blank"
                      )
                    }
                  >
