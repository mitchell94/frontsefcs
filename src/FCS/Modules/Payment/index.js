...
class Payment extends Component {
                ...
                res.data.map((r) => {
                    ...
                    temp.push({
                        ...
                        process:
                            ...
                            " - " +
                            r.Academic_semester.denomination.substr(-2),
                        type: r.type,
                    });
                });
        ...
        try {
            ...
            if (res.data) {
                ...
                res.data.map((r) => {
                    if (r.state === "Aceptado")
                        totalMovement =
                            parseFloat(r.voucher_amount) + totalMovement;
                });
                this.setState({
                    movements: res.data,
        ...
        try {
            ...
            if (res.data) {
                this.setState({
                    ...
                    totalBalance: (
                        res.data.totalMovement - res.data.totalConcept
                    ).toFixed(1),
                });
            }
            this.setState({ movementLoader: false });
    ...
    reduceTotalMovement = (type, amount) => {
        if (type === "add") {
            let temp = Math.round(
                parseFloat(this.state.totalConcept) + parseFloat(amount)
            );
            this.setState({
                totalConcept: temp,
