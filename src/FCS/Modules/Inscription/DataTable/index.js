    ...
    async createUserIntranet(id, type) {
        ...
        if (id !== "" && type !== "") {
            ...
            try {
                ...
                document.getElementById("spin-" + id).style.visibility =
                    "hidden";
                PNotify.success({
                    title: "Finalizado",
                                            ...
                                            <>
                                                ...
                                                >
                                                    <SwapHoriz
                                                        ...
                                                        onClick={() =>
                                                            this.props.openFormChangeProgram(
                                                                value
                                                            )
                                                        }
                                                    />
                                ...
                                return value.state ? (
                                    ...
                                    >
                                        <RestoreFromTrash
                                            ...
                                            onClick={() =>
                                                this.props.deleteContractSweet({
                                                    id: value.id,
                                                    state: value.state,
                                                })
                                            }
