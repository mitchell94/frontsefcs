...
class TypeDocument extends Component {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.documentType + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.documentType + '/' + id;
    ...
    render() {
        ...
        return (
            <>
                <TitleModule
                    actualTitle={"TIPOS DE DOCUMENTOS"}
                    actualModule={"TIPOS DE DOCUMENTOS"}
