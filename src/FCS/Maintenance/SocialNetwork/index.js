...
class SocialNetwork extends Component {
    ...
    async listSocialNetwork() {
        this.setState({loaderData: true})
        const url = app.general + '/' + app.socialNetwork;
        try {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.socialNetwork + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.socialNetwork + '/' + id;
    ...
    render() {
        ...
        return (
            <>
                <TitleModule
                    actualTitle={"REDES SOCIALES"}
                    actualModule={"REDES SOCIALES"}
