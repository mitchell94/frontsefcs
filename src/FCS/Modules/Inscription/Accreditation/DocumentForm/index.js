...
class DocumentForm extends React.Component {
    ...
    async listDocumentType() {
        ...
        try {
            ...
            if (res.data) this.setState({documentTypes: res.data, documentType: 5});
    ...
    handleChangeFileInput = event => {
        ...
        if ($.inArray(value, fileExtension) === -1) {
            ...
            let code = generator.generate({
                length: 3,
                prefix: this.state.belognsID + '-S-A' + moment().format('YYYYMhms'),
                count: 1,
        ...
        return (
            <Modal show={documentModal} size={"xl"} backdrop="static">
                ...
                <Modal.Header style={{background: '#00acc1'}}>
                    <Modal.Title as="h5" style={{color: '#ffffff'}}>REGISTRAR
                        DOCUMENTO {titleModalDocument}</Modal.Title>
                ...
                <Modal.Body>
                    <Row>
                        ...
                        <Col xs={12} sm={12} md={12} lg={3} xl={3}>
                            <Form.Group className="form-group fill">
                                <Form.Label className="floating-label">Descripción del documento <small
                                    className="text-danger"> *</small></Form.Label>
                                <Form.Control as="select"
                        ...
                        <Col xs={12} sm={12} md={12} lg={3} xl={3}>
                            <Form.Group className="form-group fill">
                                ...
                                <Form.Label className="floating-label">Nota <small
                                    className="text-danger"> *</small></Form.Label>
                                <Form.Control
                                    style={{marginTop: "3px"}}
                                    type="text"
