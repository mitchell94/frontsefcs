...
class DataTable extends Component {
    constructor(props) {
        super(props);
        this.state = {
            form: false, studentID: this.props.studentID,
        }
    ...
    render() {
        ...
        let total = 0;
        records.map(r => {
            if (r.state === 'Aceptado' || r.state === 'Regularizado') {
        ...
        if (records.length > 0) {
            records.map((r, index) => {
                ...
                return (data.push([index + 1, r.voucher_code, r.voucher_amount, r.voucher_date,
