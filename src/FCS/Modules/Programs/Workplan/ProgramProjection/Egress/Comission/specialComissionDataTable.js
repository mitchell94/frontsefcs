...
class SpecialComissionDataTable extends Component {
                ...
                return (
                    <>
                        <OverlayTrigger
                            ...
                            <button onClick={() => this.props.openFormComission("Pago a la comisión especial")} type="button" className="btn-icon btn btn-primary"><i
...
export default SpecialComissionDataTable;