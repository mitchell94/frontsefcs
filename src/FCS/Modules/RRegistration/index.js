...
class Registration extends Component {
  ...
  async retrieveStudent(id_student) {
    ...
    try {
      ...
      this.setState({
        titleModule:
          res.data.Person.name + " / " + res.data.Person.document_number,
                ...
                <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                  <Form.Group className="form-group fill">
                    <Form.Label className="floating-label">
                      Unidad Orgánica<small className="text-danger"> *</small>
                    </Form.Label>
                    <Form.Control
                      as="select"
                      value={organicUnit}
              ...
              {this.state.searchPerson ? (
                <Col xs={12} sm={12} md={12} lg={12} xl={12}>
                  <Form.Group className="form-group fill">
                    ...
                    >
                      Estudiante<small className="text-danger"> *</small>
                    </Form.Label>
                    <Form.Control
                      type="text"
                    ...
                    <OverlayTrigger overlay={<Tooltip>LIMPIAR</Tooltip>}>
                      <button
                    ...
                    <Table hover responsive style={{ marginTop: "-1px" }}>
                      <tbody>
                        {persons.length > 0 &&
                          persons.map((r, i) => {
                            let spanP =
                              r.Student.type === "Retirado"
                                ? "badge-warning"
                                : r.Student.type === "Abandonado"
                                ? "badge-danger"
                                : r.Student.type === "Postulante"
                                ? "badge-info"
                                : r.Student.type === "Estudiante"
                                ? "badge-primary"
                                : "badge-success";
                            ...
                            return (
                              <tr
                                key={i}
                                onClick={() => this.selectectPerson(r)}
                              >
                                <td scope="row">
                                  <div className="d-inline-block align-middle">
                                    ...
                                    <div className="d-inline-block">
                                      ...
                                      <p className="m-b-0">
                                        ...
                                        <span
                                          className={
                                            "badge  inline-block " + spanP
                                          }
                                        >
                                          {r.Student && r.Student.type}
                                        </span>
                                      </p>
                                      <p className="m-b-0">
                                        {" "}
                                        {r.Student.Program.denomination}
                                      </p>
                                    </div>
                                  </div>
                                </td>
                    ...
                    <Col xs={12} sm={12} md={8} lg={8} xl={8}>
                      <div className="d-inline-block align-middle">
                        ...
                        <div className="d-inline-block">
                          ...
                          <p className="m-b-0">
                            {this.state.documentMask}{" "}
                            <span className={"badge  inline-block " + span}>
                    ...
                    <Col xs={12} sm={12} md={4} lg={4} xl={4}>
                      <div style={{ float: "right" }}>
                        {this.state.activate !== 0 &&
                          this.state.studentType !== "Retirado" &&
                          this.state.studentType !== "Abandonado" &&
                          this.state.studentType !== "Egresado" && (
                ...
                <Col xs={12} sm={12} md={12} lg={12} xl={12} key={i}>
                  <div style={{ position: "relative" }}>
                    ...
                    <DataTableRegistration
                      ...
                      records={r}
                      optionEdit={
                        r.id_semester == this.state.process && i === 0
                          ? true
                          : false
                      }
