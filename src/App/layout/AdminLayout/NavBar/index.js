...
import logoSE from '../../../../assets/images/logo-se.png';
import logoEPG from '../../../../assets/images/logo-epg.png';
import config from "../../../../config";

const logo = config.entity == 1 ? logoEPG : logoSE;
            ...
            <Aux>
                <div className="m-header">
                    ...
                    <a href={DEMO.BLANK_LINK} className="b-brand">
                        <img style={{height: '45px', marginRight: '15px'}} id="main-logo" src={mainLogo} alt=""
                             className="logo"/>
                    </a>
                    <a className="mob-toggler" href={DEMO.BLANK_LINK} onClick={() => this.setState(prevState => {
                        return {rightToggle: !prevState.rightToggle}
                    })}><i className="feather icon-more-vertical"/></a>
                </div>
                {navHtml}
            </Aux>
        );
