...
class AdministrativeEgressDataTable extends Component {
    ...
    render() {
                ...
                return (
                    <>
                        <OverlayTrigger
                            ...
                            <button onClick={() => this.props.openFormModalAdministrativeEgress()} type="button"
                                        ...
                                        <>
                                            <OverlayTrigger
                                                ...
                                                <Edit style={{color: "#1d86e0"}}
                                                      onClick={() => this.props.retriveAdministrativeEgress(value)}
                                                />
                                            ...
                                            <OverlayTrigger
                                                ...
                                                <Delete style={{color: "#ff5252"}}
                                                        onClick={() => this.props.sweetDeleteAdministrativeEgress(value.id)}
                                                />
                                            </OverlayTrigger>
                                        </>
        ...
        if (records.length > 0) {
            records.map((r, index) => {
                    return (
                        data.push([
                            index + 1,
                            r.Administrative !== null ? r.Administrative.name : 'No registrado',
                            r.Concept !== null ? r.Concept.denomination : 'No registrado',
                            r.amount,
                            r.state_egress,
                            r
                        ])
        ...
        return (
            ...
            <MuiThemeProvider theme={this.getMuiTheme()}>
                <MUIDataTable
                    title={"LISTADO DE EGRESOS DE ADMINISTRATIVOS"}
                    data={data}
                    columns={columns}
                    options={options}
                />
...
export default AdministrativeEgressDataTable;