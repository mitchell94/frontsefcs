...
class DocumentForm extends React.Component {
    ...
    async createDocument() {
        ...
        const {fileName, file, belognsID, documentType, organicUnit, descriptionDocument, tableName} = this.state;


        if (organicUnit !== "" && fileName !== "" && belognsID !== "" && descriptionDocument !== "" && documentType !== "" && tableName !== "") {
    ...
    async updateDocument() {
        ...
        const {fileName, file, belognsID, documentType, organicUnit, descriptionDocument, documentID} = this.state;


        if (organicUnit !== "" && fileName !== "" && belognsID !== "" && descriptionDocument !== "" && documentType !== "" && documentID !== "") {
    ...
    handleChangeFileInput = event => {
        ...
        if ($.inArray(value, fileExtension) === -1) {
            ...
            let code = generator.generate({
                length: 3,
                prefix: this.state.belognsID + '-P-' + moment().format('YYYYMhms'),
                count: 1,
    ...
    render() {
        ...
        const {documentModal, documentTypes, descriptionDocument, documentType, fileName} = this.state;
