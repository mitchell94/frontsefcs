...
class StudyLevel extends Component {
    ...
    async listStudyLevel() {
        this.setState({loaderData: true})
        const url = app.general + '/' + app.studyLevel;
        try {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.studyLevel + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.studyLevel + '/' + id;
    ...
    render() {
        ...
        return (
            <>  <TitleModule
                actualTitle={"NIVELES DE ESTUDIO"}
                actualModule={"NIVEL DE ESTUDIO"}
