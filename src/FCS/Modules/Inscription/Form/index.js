...
class StudentForm extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.retriveData !== this.props.retriveData) {
            this.props.retriveData !== "" &&
                this.retriveData(this.props.retriveData);
        }
        if (prevProps.deleteStudentID !== this.props.deleteStudentID) {
            this.props.deleteStudentID !== "" &&
                this.openStudentSweetAlert(this.props.deleteStudentID);
        }
            ...
            try {
                ...
                if (res.data) {
                    this.setState({
                        ...
                        existPerson: true,
                        preview: res.data.Person.photo
                            ? app.server +
                              app.personPhotography +
                              res.data.Person.photo
                            : defaultPhoto,
    ...
    async updateStudentProgram() {
        ...
        const { costAdmission, concept, process, discount } = this.state;
    ...
    getProvince(id, type) {
        const url =
            app.general + "/" + app.ubigeo + "/" + app.province + "/" + id;
        axios
            .get(url, app.headers)
            .then((res) => {
                if (res.data) {
    ...
    getDistrict(id, type) {
        const url =
            app.general + "/" + app.ubigeo + "/" + app.district + "/" + id;
        axios
            .get(url, app.headers)
            .then((res) => {
                if (res.data) {
    ...
    handleChange = (field) => (event) => {
        switch (field) {
            case "name":
                ...
                break;
            case "paternal":
                let paternal = event.target.value
                    .replace(/[^À-ÿA-Za-z ]/g, "")
                    .toUpperCase();
                this.setState({ paternal: paternal.slice(0, 60) });
                break;
            case "maternal":
                let maternal = event.target.value
                    .replace(/[^À-ÿA-Za-z ]/g, "")
                    .toUpperCase();
            ...
            case "birthDepartment":
                this.setState({
                    birthDepartment: event.target.value,
                    birthProvince: "",
                    birthDistrict: "",
                });
            ...
            case "birthProvince":
                this.setState({
                    birthProvince: event.target.value,
                    birthDistrict: "",
                });
            ...
            case "residentDepartment":
                this.setState({
                    residentDepartment: event.target.value,
                    residentProvince: "",
                    residentDistrict: "",
                });
            ...
            case "residentProvince":
                this.setState({
                    residentProvince: event.target.value,
                    residentDistrict: "",
                });
            ...
            case "program":
                ...
                break;
            case "admissionPlan":
                let studyPlan = $("#admissionPlan-" + event.target.value).attr(
                    "data-studyPlan"
                );
                let process = $("#admissionPlan-" + event.target.value).attr(
                    "data-process"
                );
                let studyPlanMask = $(
                    "#admissionPlan-" + event.target.value
                ).attr("data-studyPlanMask");
                this.setState({
                    admissionPlan: event.target.value,
                    studyPlan: studyPlan,
                    process: process,
                ...
                break;
            case "costAdmission":
                let concept = $("#concept-" + event.target.value).attr(
                    "data-concept-id"
                );
                this.setState({
                    costAdmission: event.target.value,
                    concept: concept,
                });
                break;
    ...
    changeAvatar = (event) => {
        ...
        if ($.inArray(value, fileExtension) === -1) {
            let message =
                "Por favor use estos formatos: " + fileExtension.join(", ");
            Swal.fire({
                                        ...
                                        <Row>
                                            <Col sm={4}>
                                                ...
                                                >
                                                    ...
                                                    {birthDepartments.length >
                                                    0 ? (
                                                        birthDepartments &&
                                                        birthDepartments.map(
                                                            (
                                                                birthDepartment,
                                                                index
                                                            ) => {
                                        ...
                                        <Row>
                                            ...
                                            <Col sm={4}>
                                                ...
                                                >
                                                    ...
                                                    {residentProvinces.length >
                                                    0 ? (
                                                        residentProvinces &&
                                                        residentProvinces.map(
                                                            (
                                                                residentProvince,
                                                                index
                                                            ) => {
                                            ...
                                            <Col sm={4}>
                                                ...
                                                >
                                                    ...
                                                    {residentDistrics.length >
                                                    0 ? (
                                                        residentDistrics &&
                                                        residentDistrics.map(
                                                            (
                                                                residentDistrict,
                                                                index
                                                            ) => {
