        ...
        return (
            <span>
                <Tooltip title={"Editar"}>
                    <IconButton onClick={() => this.props.handleClickRetrieveRecord(record)} aria-label="Editar">
                      <i className="material-icons text-primary">edit</i></IconButton>
                </Tooltip>
                <Tooltip title={"Eliminar"}>
                    <IconButton onClick={() => this.props.handleOpenSweetAlertWarning(record.id)} aria-label="Eliminar">
