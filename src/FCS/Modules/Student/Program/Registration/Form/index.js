...
class FormAcademicRecord extends React.Component {
    ...
    async createRegistration() {
        ...
        const {concept, amount, courses, process, typeRegistration} = this.state;
    ...
    render() {
        ...
        const {process, academicCalendar,  titleConcept,  typeRegistration} = this.state;
        const {academicCalendars, processs, amount} = this.state;
