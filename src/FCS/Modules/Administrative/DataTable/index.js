    ...
    render() {
                            ...
                            return value ?
                                <>
                                    <OverlayTrigger
                                        ...
                                        <Link to={"/administrative/" +  btoa(value.id) + "/contract"}> <Details className={"text-warning"}/></Link>
                                    </OverlayTrigger>
                                    <OverlayTrigger
            ...
            records.map((r, index) => {
                    ...
                    return (
                        data.push([
                            ...
                            r.document_number,
                            r.email,
                            r.Administratives[0].Organic_unit.denomination,
                            r
                        ])
                    )
                }
        ...
        return (
            ...
            <MuiThemeProvider theme={this.getMuiTheme()}>
                <MUIDataTable
                    title={"LISTADO DEL PERSONAL ADMINISTRATIVO"}
                    data={data}
                    columns={columns}
                    options={options}
                />
