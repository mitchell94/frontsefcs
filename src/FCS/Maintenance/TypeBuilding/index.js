...
class TypeBuilding extends Component {
    constructor(props) {
        super(props);
        this.state = {

            loaderData: true,
            module: "TIPOS DE EDIFICACIONES",
            showModal: false,
            loader: false,
            action: "add",
            titleModel: "",
    ...
    componentDidMount() {
        this.listTypeBuilding();

    }

    async listTypeBuilding() {
        this.setState({loaderData: true})
        const url = app.general + '/' + app.typeBuilding;
        try {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.typeBuilding + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.typeBuilding + '/' + id;
