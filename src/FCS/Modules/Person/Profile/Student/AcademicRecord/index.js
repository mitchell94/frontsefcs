...
export default class AcademicRecord extends Component {
    ...
    */
    ...
    getRecordStudent(studentID) {
        const url = app.registration + '/' + app.registrations + '/' + studentID + '/' + app.student;
        ...
        return (
            <Row>
                        ...
                        <Col key={index} md={12}>
                            <Card style={{marginBottom: "14px"}}>
                                <Card.Header className='h-40' style={{height: '40px', marginBottom: '-1px'}}>
                                    <div className="d-inline-block align-middle" style={{marginTop: '-25px'}}>
                                        <div className="d-inline-block">
                                            <h5>{r.AS.denomination + " - " + r.AS.AC.denomination.replace('CALENDARIO ACADEMICO', '')}</h5>
                                        ...
                                        <tbody>
                                        {
                                            ...
                                            r.Registration.length > 0 ?
                                                r.Registration.map((k, i) => {
                                                    ...
                                                    totalCredit = totalCredit + k.Course.credits;

                                                    return (
                                                        <tr key={i} className="d-flex" onClick={() => this.CourseDetail.handleOpenModal(k)}>
                                                            <td className="col-1">
                                                                <div className="d-inline-block align-middle">
                                                                    <div className="d-inline-block">
                                                                        <p className="m-b-0"> {k.Course.order}</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td className="col-6">
                                                            ...
                                                            <td className="col-1">
                                                                <div className="d-inline-block align-middle">
                                                                    ...
                                                                    <div className="d-inline-block">
                                                                        <p className="m-b-0"
                                                                        > {k.Course.Semester_mention.semester.replace('Semestre', '')}</p>
                                                            ...
                                                            <td className="col-2">
                                                                       <span
                                                                           className={'badge badge-' + span + ' inline-block'}>{k.state}</span>
                                                ...
                                                <tr className="d-flex">
                                                    <td className="col-12">
                                                        <div className="d-inline-block align-middle">
                                                            ...
                                                            <div className="d-inline-block">
                                                                <p className="m-b-0"> No hay cursos registrados</p>
                                                            </div>
                                                        </div>
                                ...
                                <Card.Footer className='h-40' style={{height: '40px'}}>
                                    <p className="task-due card-text"><strong> Creditos : </strong><strong
                                        className="label label-primary">{totalCredit}</strong></p>
                ...
                <CourseDetail
                    ...
                    getRecordStudent={()=>this.getRecordStudent(this.state.studentID)}
