...
class FormAcademicRecord extends React.Component {
    ...
    closeForm = () => {
        ...
        this.setState({
            acacdemicCalendar: "", process: "", typeRegistration: "Regular", courses: []
        })
    ...
    render() {
        ...
        const {process, titleConcept, observation, typeRegistration} = this.state;
                            ...
                            <Col xs={12} sm={12} md={3} lg={3} xl={3}>
                                <Form.Group className="form-group fill">
                                    ...
                                    <Form.Control as="select"
                                        ...
                                        <option value="Curso desaprobado por Credito">Curso desaprobado por Credito (R)
                                        </option>
