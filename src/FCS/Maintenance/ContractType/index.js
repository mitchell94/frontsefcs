...
class ContractType extends Component {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.contractType + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.contractType + '/' + id;
    ...
    render() {
        ...
        return (
            <>
                <TitleModule
                    actualTitle={"TIPOS DE CONTRATO"}
                    actualModule={"TIPO DE CONTRATO"}
