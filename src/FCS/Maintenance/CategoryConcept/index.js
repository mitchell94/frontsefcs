...
class CategoryConcept extends Component {
    constructor(props) {
        super(props);
        this.state = {

            loaderData: true,
            module: "CATEGORIA CONCEPTO",
            showModal: false,
            loader: false,
            action: "add",
            titleModel: "",
    ...
    async save() {
        ...
        const {description, order} = this.state;
    ...
    async update() {
        ...
        if (description !== '' && order !== '') {
            ...
            const url = app.general + '/' + app.categoryConcept + '/' + this.state.actualID;
            let data = new FormData();
            data.set('description', description);
            data.set('order', order);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.categoryConcept + '/' + id;
    ...
    render() {
        ...
        return (
            <>
                <TitleModule
                    actualTitle={"CATEGORIA CONCEPTOS"}
                    actualModule={"CATEGORIA CONCEPTOS"}
