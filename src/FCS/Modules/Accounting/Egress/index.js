...
export default class Egress extends Component {
    ...
    getConcepts() {
        ...
        const url = app.accounting + '/' + app.concepts + '/Egress';
    ...
    saveEgress(cashboxProps, initialBalanceID) {
    ...
    handleRetrieveEgress = record => {
        this.getConcepts();
        this.setState({
            isVarying: true,
            action: 'update',
            titleModal: 'MODIFICAR EGRESO',
            currentID: record.id,
        ...
        return (
            <>
                <Modal show={this.state.isVarying} onHide={() => this.setState({isVarying: false})}>
                    <Modal.Header style={{background: '#ff5252'}}>
                    ...
                    <Modal.Body>
                        ...
                        {action === 'add' ?
                            <Button
                                ...
                                disabled={disabled}
                                variant="primary"
                                onClick={() => this.saveEgress(cashboxProps, initialBalanceID)}>
                                {disabled &&
