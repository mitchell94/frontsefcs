...
class AcademicDegree extends Component {
    ...
    componentDidMount() {
        ...
        this.listAcademicDegree();

    }

    async listAcademicDegree() {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.academicDegree + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.academicDegree + '/' + id;
    ...
    render() {
        ...
        return (
            <>
                <TitleModule
                    actualTitle={"GRADOS ACADEMICOS"}
                    actualModule={"GRADOS ACADEMICOS"}
