...
class Breadcrumb extends Component {
    ...
    componentDidMount() {
        this.props.moduless && this.breadCrumb()
    };

    breadCrumb = () => {
        this.props.moduless.map((item, index) => {
    ...
    UNSAFE_componentWillReceiveProps = () => {
        this.props.moduless && this.props.moduless.map((item, index) => {
            if (item.type && item.type === 'group') {
