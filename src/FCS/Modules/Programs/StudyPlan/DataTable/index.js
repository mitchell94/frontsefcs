                ...
                return (
                    <>
                        <OverlayTrigger
                            ...
                            <button onClick={() => this.props.openModalPlan()} type="button"
                        ...
                        if (value === undefined) {
                            ...
                            return value ?
                                <div className="custom-control custom-switch"
                                     onClick={() => this.props.actualPlan(value.id)}>
                                    <input type="checkbox" className="custom-control-input" id={value.id} readOnly
                                           checked={value.valid}/>
                            ...
                            if (value === "") {
                                ...
                                return (<>
                                    <OverlayTrigger
                                        ...
                                        <Bookmark type="button" className="text-dark"
                                                  onClick={() => this.props.openFormCourse(value)}/>

                                    </OverlayTrigger>
                                    <OverlayTrigger
                                        overlay={<Tooltip>EDITAR</Tooltip>}>
                                        <Edit type="button" style={{color: "#1d86e0"}}
                                              onClick={() => this.props.retrivePlan(value)}/>

                                    </OverlayTrigger>
                                    <OverlayTrigger
                                        overlay={<Tooltip>ANULAR</Tooltip>}>
                                        <Delete type="button" style={{color: "#ff5252"}}
                                                onClick={() => this.props.deleteSweetPlan(value.id, value.state)}/>
