...
class Bank extends Component {
    ...
    async update() {
        ...
        if (denomination !== '') {
            ...
            const url = app.general + '/' + app.bank + '/' + this.state.actualID;
            let data = new FormData();
            data.set('denomination', denomination);
    ...
    async delete(id) {
        try {
            const url = app.general + '/' + app.bank + '/' + id;
    ...
    render() {
        ...
        const {showModal, loader, action, titleModal, moduleName} = this.state;
        const {denomination} = this.state;
                ...
                <Row>
                    ...
                    <Col xs={12} sm={12} md={10} lg={10} xl={10}>
                        <div style={{position: 'relative'}}>
                            ...
                            <DataTable records={records} openSweetAlert={this.openSweetAlert} openModal={this.openModal} openEditModal={this.openEditModal}/>
                        </div>
                    </Col>
                </Row>
